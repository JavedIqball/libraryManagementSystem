...
@csrf
    <div class="mb-3">
        ...
        <input type="hidden" class="form-control" id="id" name="id" value="" aria-describedby="id">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="username" name="username" value="" aria-describedby="username">
        ...
        <button type="submit" class="btn btn-primary">AssignBook</button>
